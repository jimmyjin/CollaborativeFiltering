...
__author__ = "Shengmin JIN"
__email__ = "sjin09@syr.edu"

from recommendation_data import dataset
from math import sqrt


# Returns cosine similarity of user1 and user2
...
def similarity_score(user1, user2):
    ...
    for item in dataset[user1]:
        ...
        for item in dataset[user1]:
            if item in dataset[user2]:
                sum_of_eclidean_distance.append(pow(dataset[user1][item] - dataset[user2][item], 2))
